...
open class TypeFaceUtils {
    ...
    companion object {
        fun overrideFont(context: Context, name: String, path: String) {
            val customFontTypeFace: Typeface = Typeface.createFromAsset(context.assets, path)
            val map = HashMap<String, Typeface>()
            map["recursive"] = customFontTypeFace
            try {
